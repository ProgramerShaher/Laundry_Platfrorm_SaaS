...
[DependsOn(
    typeof(laundry_SaaSApplicationTestModule),
    typeof(laundry_SaaSEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class laundry_SaaSEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new laundry_SaaSDbContext(new DbContextOptionsBuilder<laundry_SaaSDbContext>().UseSqlite(_database.ConnectionString).Options));
